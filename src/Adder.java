/* Generated By:JavaCC: Do not edit this line. Adder.java */
  ...
  final public Integer Start() throws ParseException {
                  Integer num; Adder ad;
    ad = Z();
    num = X(ad);
                       System.out.println("El resultado es: "+num);  {if (true) return num;}
  ...
  final public Integer XP(Adder letras, Integer carril) throws ParseException {
                                          Integer dato1, res;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MAS:
      jj_consume_token(MAS);
      dato1 = T(letras);
      res = XP(letras, carril+dato1);
                                                         {if (true) return res;}
      break;
    case MENOS:
    ...
    default:
      jj_la1[0] = jj_gen;
        {if (true) return carril;}
    }
    throw new Error("Missing return statement in function");
  }

  final public Integer T(Adder letras) throws ParseException {
                         Integer numero; Integer res;
    numero = F(letras);
    res = TP(numero,letras);
                                             {if (true) return res;}
    throw new Error("Missing return statement in function");
  }

  final public Integer TP(Integer carril, Adder letras) throws ParseException {
                                          Integer numero;Integer res;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MUL:
      jj_consume_token(MUL);
      numero = F(letras);
      res = TP(carril*numero,letras);
                                                       {if (true) return res;}
      break;
    case DIV:
